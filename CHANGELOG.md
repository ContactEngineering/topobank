...
- MAINT: Added SI unit information and conversion factors to analysis
  results (in preparation for #795)
- MAINT: Switched JSON keys in results dictionary to CamelCase
  (in preparation for #795)

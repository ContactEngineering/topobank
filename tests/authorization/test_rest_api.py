...
def test_add_remove_user(api_client, one_line_scan, user_alice):
    ...
    response = api_client.post(
        reverse("authorization:grant-user-access-v1", kwargs={"pk": surface.permissions.id}),
    ...
    response = api_client.post(
        reverse("authorization:revoke-user-access-v1", kwargs={"pk": surface.permissions.id}),
...
def test_add_remove_organization(api_client, one_line_scan, user_alice, org_blofield):
    ...
    response = api_client.post(
        reverse(
            "authorization:grant-organization-access-v1", kwargs={"pk": surface.permissions.id}
        ),

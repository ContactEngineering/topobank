...
from topobank.analysis.registry import (
    AlreadyRegisteredAnalysisFunctionException,
    AnalysisRegistry,
...
def test_register_function_with_different_kwargs():
    ...
    def func2(
        topography, a=1, b="foo", c="bar", progress_recorder=None, storage_prefix=None
    ):
        pass
...
def test_availability_of_implementation_in_plugin(
    ...
    mocker.patch.object(
        topography_analysis_function_for_tests, "__module__", fake_func_module
    )

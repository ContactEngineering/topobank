...
def forward_func(apps, schema_editor):
    ...
    for analysis in Analysis.objects.all():
        ...
        try:
            ...
            # The subject of this analysis does not exist. This is an orphaned analysis. We delete it.
            _log.info(f'Deleting orphaned analysis {analysis.id} (Function {analysis.function.name} with kwargs '
                      f'{analysis.kwargs})...')
            analysis.delete()

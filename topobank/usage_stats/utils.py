...
def current_statistics(user=None):
    ...
    unpublished_topographies = Topography.objects.filter(subject__surface__in=unpublished_surfaces)
    unpublished_analyses = Analysis.objects.filter(subject__topography__in=unpublished_topographies)
